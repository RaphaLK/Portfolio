    ...
    <div className="flex flex-col items-center font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="grid grid-cols-3 grid-rows-2 ">
        ...
        <ProjectCard
          ...
          ProjectInfo={
            "Web App to enable students to create their Academic four year plan. Acted as the scrum master during weekly meetings, identifying tasks and assessing priority. I was also the main developer in this project, directing other team members to complete their tasks in a timely manner and providing learning resources. Spearheaded design choices, integrated Firebase authentication and Cloud storage to our WebApp. Designed a normalized Database schema to reduce redundancies."
          }
        />
        <ProjectCard
        ...
        />
          <ProjectCard
            ...
            ProjectInfo={"An experimental component. Was meant to test the viability of a Bottom Tab Navigator and a 'Pull-Up' Sheet for Public Transport Hub. This was something I made when I first hopped onto the Public Transit Hub project, and I was tasked with UI updates! One of the first things I made with React Native, and this set me up for my other projects."}
          />
        <ProjectCard
          ProjectTitle={"Allescan"}
          ProjectDescription={"Flutter, Firebase, Google Vision API"}
          ProjectInfo={"Allescan was my first Hackathon Project. I worked on the Front End and Firebase Integration. We utilized the Google Vision API to identify nutrient labels and identify and user allergens. This was an incredible learning experience and was my first introduction to Mobile App Development."}
        />
      </div>
    </div>
  );
