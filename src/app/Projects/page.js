  ...
  const projects = [
    {
      ...
      githubLink: "github.com/RaphaLK/MiniRustOS",
    },
    {
      title: "NextGig",
      description: "C++17, Qt, Firebase SDK, TCP/IP, CMake, JSON",
      info: "Built a freelancer job portal using C++ and the Qt framework, demonstrating SOLID principles and design patterns like Observer and Factory. Implemented a client-server architecture with JSON-based RPC protocol and Firebase C++ SDK integration for user authentication and data persistence.",
    ...
    },
    {
      ...
      info: "Designed and implemented a 5-stage pipelined CPU with a custom instruction set architecture inspired by RISC-V. Created logic for instruction fetch, decode, execute, memory access, and writeback stages with hazard detection and forwarding units. Verified functionality through simulation and FPGA implementation.",
    },
    {
      title: "Simple C Compiler",
      description: "C++, Flex, Bison, x86-64 Assembly, LLVM",
      ...
      githubLink: "https://github.com/RaphaLK/SimpleCompiler",
    },
    {
      title: "Systemic Mobile App Reviews",
      description: "React, Node.js, BullMQ, AWS, MongoDB, Nginx",
      info: "Enhanced a web platform for non-technical researchers to systematically analyze mobile applications. Implemented a task scheduling system with BullMQ, developed an API for Google Play Store metadata extraction, and created a responsive UI dashboard for displaying app analytics and user behavior patterns.",
